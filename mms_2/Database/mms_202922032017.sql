...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2017 at 03:58 PM
...
INSERT INTO `miracle` (`id`, `title`, `description`, `image`) VALUES
(1, 'xfd h h', '<p>hytbendynyt kjyug vk i7t ccuytr &nbsp;uytfjgv ,jhv &nbsp; bfl.khned fwebuaeruio rtttttttttt euhfl abuehf</p>', '1_sparklers.jpg');
...
INSERT INTO `offers` (`id`, `title`, `description`, `image`) VALUES
(1, 'my offers', '<p>ngdcrjmhtfg kuyf kyug jhyg kuygv,jhg utfufv ,k kuytg cjh</p>', '1_.coworkers.jpg');
