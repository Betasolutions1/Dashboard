...
function validate()
    ...
    if(document.form.area.value == "")
     {
      alert("Error: Please provide Description!");
      form.area.focus();
      return false;
    }
         if(document.form.area1.value == "" )
         {
            alert( "Please provide Product Price " );
            document.form.area1.focus() ;
            return false;
         }
         if(document.form.area2.value == "" )
         {
            alert( "Please upload Image " );
            document.form.area2.focus() ;
            return false;
         }
     }
</script>
...
<div class="row">
  ...
  <button type="submit"  class="remodal-confirm" href="#" >Submit</button>
</form>
</div>
