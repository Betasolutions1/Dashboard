...
INSERT INTO `services` (`service_id`, `service_type`, `service_title`, `service_desc`, `service_img`) VALUES
(1, 'Mobile', 'zfg hbxdfh  sertg szgy sre g rtysy ery', '<p>zrae gr htrfg hyjf ;pu if jfp &nbsp;wye bcjof &nbsp;uahd bjc/ wu an.l er geryt srt gyaezr er&nbsp;</p>', '3_user.png');
